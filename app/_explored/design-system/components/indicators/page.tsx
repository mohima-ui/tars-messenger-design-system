    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="mx-auto max-w-[1080px] px-8 py-12">
        ...
        <footer className="mt-20 flex items-center justify-between border-t pt-8 pb-12 text-[12px] text-[#979797]" style={{ borderColor: CHROME }}>
          <a href="/explored/design-system/components/ai-message" className="transition-colors hover:text-[#333333]">← AI Message</a>
          <a href="/explored/design-system/components/user-message" className="transition-colors hover:text-[#333333]">User Message →</a>
        </footer>
      </main>
    </div>
  );
