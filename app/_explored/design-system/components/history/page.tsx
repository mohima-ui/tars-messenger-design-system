    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="mx-auto max-w-[1080px] px-8 py-12">
        ...
        <footer className="mt-20 flex items-center justify-between border-t pt-8 pb-12 text-[12px] text-[#979797]" style={{ borderColor: CHROME }}>
          <a href="/explored/design-system/components/launcher" className="transition-colors hover:text-[#333333]">← Launcher</a>
          <a href="/explored/design-system" className="transition-colors hover:text-[#333333]">All components →</a>
        </footer>
      </main>
    </div>
  );
