...
export default function LauncherVariantsPage() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#FFFDFA" }}>
      ...
      >
        <div className="mx-auto flex max-w-[1080px] items-center justify-between px-8 py-4">
          <div className="flex items-baseline gap-3">
            <a
              href="/explored/design-system/components/launcher"
      ...
      >
        <a href="/explored/design-system/components/launcher" className="transition-colors hover:text-[#333333]">
          ← Launcher
        </a>
        <a href="/explored/design-system" className="transition-colors hover:text-[#333333]">
          Foundation →
        </a>
      </footer>
    </div>
