      ...
      <main className="mx-auto max-w-[1080px] px-8 py-12">
        ...
        <div className="flex flex-col gap-12">
          ...
          <section>
            ...
            <div className="flex flex-col gap-4 rounded-[14px] border bg-[#FAF6EE] p-6" style={{ borderColor: LINE }}>
          ...
          <section>
            ...
            <div
              className="grid grid-cols-1 gap-4 rounded-[14px] border bg-[#FAF6EE] p-6 lg:grid-cols-[360px_1fr]"
              style={{ borderColor: LINE }}
            >
              <VoiceMode />
          ...
          <section>
            ...
            <div className="flex items-center justify-center rounded-[14px] border bg-[#FAF6EE] p-12" style={{ borderColor: LINE }}>
              <HoldToTalk />
            </div>
