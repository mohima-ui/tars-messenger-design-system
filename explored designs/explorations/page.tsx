...
const EXPLORATIONS: { href: string; title: string; note: string }[] = [
  ...
  {
    href: "/explorations/v7",
    title: "v7 — Welcome screen",
    note: "Pre-conversation entry: centered brand mark, floating suggested prompts, and an 'Ask anything' composer. Mobile, full-screen.",
  },
  {
