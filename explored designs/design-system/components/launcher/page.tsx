    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="mx-auto max-w-[1080px] px-8 py-12">
        ...
        <footer className="mt-20 flex items-center justify-between border-t pt-8 pb-12 text-[12px] text-[#979797]" style={{ borderColor: CHROME }}>
          <a href="/explored/design-system/components/error" className="transition-colors hover:text-[#333333]">← Error</a>
          <a href="/explored/design-system/components/history" className="transition-colors hover:text-[#333333]">History →</a>
        </footer>
      </main>
    </div>
  );
