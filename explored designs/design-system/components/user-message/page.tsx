const LINE = "#E0DAD3";
const CHROME = "#E5E5E5";
const USER_BG = "#F0E7FA";
const USER_BORDER = "#C5A8E0";
const USER_TEXT = "#4A1F77";
...
const ANATOMY = [
  { label: "Bubble container", token: "max-w-[80%] · rounded 12/12/4/12 · inset accent-stroke" },
  { label: "Content", token: "14px regular · accent-ink" },
  { label: "Alignment", token: "justify-end (right-aligned)" },
];

const SPECS = [
  { prop: "Background", value: "#F0E7FA", note: "--accent-soft (Tars purple; per tenant)" },
    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="mx-auto max-w-[1080px] px-8 py-12">
        ...
        <footer className="mt-20 flex items-center justify-between border-t pt-8 pb-12 text-[12px] text-[#979797]" style={{ borderColor: CHROME }}>
          <a href="/explored/design-system/components/indicators" className="transition-colors hover:text-[#333333]">← Indicators</a>
          <a href="/explored/design-system/components/human-agent" className="transition-colors hover:text-[#333333]">Human Agent →</a>
        </footer>
      </main>
    </div>
  );
